        ...
        if ($accessWord == 'yes') {
            ...
            if ($functionName == 'edit') {
                ...
                if ($this->contentObject->attribute('current_version') == 1 && !$this->contentObject->attribute('status')) {
                    ...
                    $mainNode = eZNodeAssignment::fetchForObject($this->contentObject->attribute('id'),
                        $this->contentObject->attribute('current_version'));
                    /** @var eZContentObject $parentObj */
                ...
                foreach (array_keys($limitationArray) as $key) {
                    ...
                    switch ($key) {
                        case 'Class': {
                            if ($functionName == 'create' and
                                ...
                                $access = 'allowed';
                                       ...
                                       in_array($this->contentObject->attribute('contentclass_id'),
                                           $limitationArray[$key])
                            ) {
                                $access = 'allowed';
                            } else {
                        ...
                        case 'ParentOwner': {
                            ...
                            if (in_array(2, $limitationArray[$key]) && $this->user->isAnonymous()) {
