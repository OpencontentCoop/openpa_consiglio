<form>
    ...
    <h1>Nota spese {$politico.object.name|wash()} {if $politico.is_in['giunta']}(assessore){/if}
        <small>{$interval_name}</small>
    </h1>
    ...
    <table class="table">
        ...
        {foreach $sedute as $seduta}
            ...
            <tr>
                <td style="vertical-align: middle">{$seduta.data_ora|l10n('date')|wash()}
                    <small>{$seduta.data_ora|l10n('shorttime')}</small>
                </td>
...
<a href="{concat('consiglio/gettoni/',$interval,'/',$politico.object.id, '/export_report/')|ezurl(no)}" class="btn btn-xs btn-info pull-right">Esporta in formato Excel</a>

{ezscript_require( array( 'modernizr.min.js', 'ezjsc::jquery',  'bootstrap/tooltip.js', 'bootstrap/popover.js', 'bootstrap-editable.min.js', 'jquery.fileupload.js', 'photobooth_min.js' ) )}
{ezcss_require(array('bootstrap3-editable/css/bootstrap-editable.css', 'jquery.fileupload.css'))}
<style>{literal}.photobooth ul, .photobooth ul li {
        margin: 0;
        padding: 0;
        list-style: none
    }{/literal}</style>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" enctype="multipart/form-data" method="post"
                    ...
                    <div id="cameraContainer" class="clearfix text-center"
                         data-url="{concat('consiglio/gettoni/',$interval,'/',$politico.object.id, '/add_spesa' )|ezurl(no)}">
                        <p>oppure</p>
                        ...
                        <div id="camera" style="display: none;height:240px;width:320px"
                             class="center-block"></div>
                        <div id="gallery" style="height:240px;width:320px;display: none"
                             class="center-block"></div>
                        <p>
