...
<p>
Si ricorda che per una visione puntale dell'ordine del giorno è necessario accedere all’area riservata del sistema informatico realizzato a supporto dell’attività del Consiglio delle autonomie locali, disponibile all’indirizzo {social_pagedata('consiglio').site_url}</p>
