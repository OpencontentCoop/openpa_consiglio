{set-block scope=root variable=subject}Punto di Suo competenza{/set-block}

Con la presente La informo che nella <strong>{$punto.seduta.object.name|wash()}</strong> è pubblicato il seguente punto in materia di {$punto.materia|implode( ', ' )}, che risulta di Sua competenza:<br><br>
