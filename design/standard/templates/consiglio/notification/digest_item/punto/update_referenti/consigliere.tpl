...
{if is_set( $diff.referente_politico )}
    Il nuovo referente politico è {foreach $diff.referente_politico.new.content.relation_list as $relation}{fetch( content, object, hash( object_id, $relation.contentobject_id ) ).name|wash} {/foreach}.
{/if}
