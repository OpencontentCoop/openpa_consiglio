...
come richiesto si segnala che, nell’area riservata del sistema informatico disponibile all’indirizzo {social_pagedata('consiglio').site_url}, in corrispondenza della {$punto.seduta.object.name|wash()}, è stato pubblicato il seguente punto in materia di <em>{$punto.materia}</em>:
