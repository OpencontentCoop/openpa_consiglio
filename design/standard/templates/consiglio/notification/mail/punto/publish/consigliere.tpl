...
Con la presente La informo che nell'area riservata del sito Cal.tn.it, in corrispondenza della '{$seduta.object.name|wash()}', è stato pubblicato il seguente punto in materia di '{$seduta.materia|implode( ', ' )}':<br><br>
