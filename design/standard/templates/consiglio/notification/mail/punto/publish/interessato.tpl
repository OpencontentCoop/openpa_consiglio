...
Sulla base delle preferenze di notifica da Lei selezionate all’interno del sito cal.tn.it, La informo che nella <strong>{$seduta.object.name|wash()}</strong> è stato pubblicato il seguente punto in materia di {$punto.materia|implode( ', ' )}:<br><br>
