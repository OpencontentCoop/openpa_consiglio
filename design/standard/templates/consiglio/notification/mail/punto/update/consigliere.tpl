...
<p>Con la presente La informo che nell'area riservata del sito Cal.tn.it, in corrispondenza della '{$seduta.object.name|wash()}', è stato aggiornato il punto in materia di '{$seduta.materia|implode( ', ' )}':</p>
