...
<p>Si ricorda che per una visione puntale dell'ordine del giorno è necessario accedere all’area riservata del sistema informatico realizzato a supporto dell’attività del Consiglio delle autonomie locali, disponibile all’indirizzo {social_pagedata('consiglio').site_url}</p>

<p>
    Per l’accesso rapido all’area riservata è sempre possibile riferirsi al seguente link: <a href="http://{social_pagedata('consiglio').site_url}/{$seduta.editorial_url}">Ordine del giorno della seduta</a>
</p>
