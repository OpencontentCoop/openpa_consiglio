{def $social_pagedata = social_pagedata('consiglio')}
...
<table align='center' border='0' cellpadding='0' cellspacing='0' id='backgroundTable'>
        ...
        <td align='center'>
            <center>
                <table border='0' cellpadding='20' cellspacing='0'
                       style='margin-left: auto;margin-right: auto;width:600px;text-align:center;'
                       width='600'>
                    <tr>
    ...
    <tr>
        <td align='left'>
            <table border='0' bgcolor='#fff' cellpadding='30' cellspacing='0'
                   style='margin-left: auto;margin-right: auto;width:600px;text-align:left;background: #fff'
                   width='600'>
                <tr>
                    <td>
                        {$content}
                        ...
                        <hr/>
                        <small>
                            Messaggio generato automaticamente, si prega di non rispondere <br/>
