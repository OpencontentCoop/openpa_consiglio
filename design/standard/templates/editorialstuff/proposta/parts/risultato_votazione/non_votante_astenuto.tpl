...
{if $post.current_state.identifier|ne('closed')}
    <tr>
        ...
        <td class="presenti">
            <small>{foreach $post_result.presenti as $partecipante}{$partecipante.object.name|wash()}{delimiter}, {/delimiter}{/foreach}</small>
        </td>
    </tr>
    <tr>
        ...
        <td class="assenti">
            <small>{foreach $post_result.assenti as $partecipante}{$partecipante.object.name|wash()}{delimiter}, {/delimiter}{/foreach}</small>
        </td>
    </tr>
{/if}
{if $post.current_state.identifier|eq('closed')}
            ...
            <table class="table table-bordered">
               ...
               {* <tr>
                    ...
                    <td style="vertical-align: middle" class="votanti">
                        ...
                        <small>{foreach $post_result.non_votanti as $partecipante}{$partecipante.object.name|wash()}{delimiter}, {/delimiter}{/foreach}</small>
                    </td>
                </tr>*}
            </table>
        </td>
	...
	<tr>
	    <th style="vertical-align: middle">Non hanno espresso una preferenza</th>
            <td style="vertical-align: middle" align="center">{$post_result.non_votanti_count}</td>
	    <td style="vertical-align: middle" class="non-votanti">{foreach $post_result.non_votanti as $partecipante}{include uri='design:editorialstuff/consiglio_default/parts/risultato_votazione/partecipante_in_votazione.tpl' votazione=$post partecipante=$partecipante anomalie=$anomalie} {/foreach}</td>
	</tr>
    {undef $anomalie}
{/if}
</table>
