                ...
                <form action="" enctype="multipart/form-data" method="post" id="upload-form" class="form-horizontal">
                    ...
                    <div class="clearfix">
                        <span class="btn btn-success btn-lg fileinput-button pull-right">
                            ...
                            <input id="DocFile" type="file" name="DocFile[]" data-url="{concat('editorialstuff/file/punto/upload/', $post.object.id, '/documenti' )|ezurl(no)}" />
                        </span>
                    </div>
            ...
            $('#DocFile').fileupload({
                ...
                submit: function (e, data) {
                    ...
                    if (data.result.errors.length > 0) {
                        ...
                        errorContainer.prependTo($('#docs'));
                    } else if (typeof data.result.content != 'undefined') {
                        $('#docs').html(data.result.content);
                    }
                    $('#upload-form').show();
                    $('#upload-loading').hide();
                }
