...
<div class="row">
    <div class="col-sm-12" id="dashboard-filters-container">
        <form class="form-inline" role="form" method="get"
            ...
            {if and(is_set($factory_configuration.CreationRepositoryNode), $factory_configuration.CreationRepositoryNode, is_set($factory_configuration.CreationButtonText))}
            ...
            {/if}            
            {if and(is_set($factory_configuration.BrowseStartNode), $factory_configuration.BrowseStartNode, is_set($factory_configuration.BrowseButtonText))}
